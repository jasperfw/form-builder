...
class FormElementTest extends TestCase
{
    public function testConstruct()
    {
        $config = [
            ...
            'formelement' => FormElement\Textfield::class,
            'label' => 'Title:',
            'required' => false,
            'default' => 'defaultvalue',
        ];
        /** @var FormElement $element */
        $element = $this->getMockForAbstractClass(FormElement::class, ['test', $config]);
        $this->assertEquals(
        ...
        $this->assertEquals(
            '<input id="test-field" name="test" value="uservalue" style="color: black;" class="test-field" />',
            $element->outputElement(),
            'Incorrect element'
        );
        $this->assertEquals(
            '<div class="formgroup"><label for="test-field">Title:</label> <input id="test-field" name="test" value="uservalue" style="color: black;" class="test-field" />  </div><br />',
