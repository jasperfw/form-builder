...
use JasperFW\FormBuilder\FormElement\Emailfield;
...
class EmailfieldTest extends TestCase
{
    public function testConstruct()
    {
        $config = [
            ...
            'formelement' => Emailfield::class,
            'label' => 'Title:',
            'required' => false,
            'default' => 'defaultvalue',
        ];
        $element = new Emailfield('test', $config);
        $this->assertEquals(
        ...
        $this->assertEquals(
            '<input id="test-field" value="uservalue" name="test" type="email" style="color: black;" class="test-field" />',
            $element->outputElement(),
            'Incorrect element'
        );
        $this->assertEquals(
            '<div class="formgroup"><label for="test-field">Title:</label> <input id="test-field" value="uservalue" name="test" type="email" style="color: black;" class="test-field" />  </div><br />',
