...
use JasperFW\FormBuilder\FormElement\Input;
...
class InputTest extends TestCase
{
    public function testConstruct()
    {
        $config = [
            ...
            'formelement' => Input::class,
            'label' => 'Title:',
            'required' => false,
            'default' => 'defaultvalue',
        ];
        $element = new Input('test', $config);
        $this->assertEquals(
        ...
        $this->assertEquals(
            '<input id="test-field" value="uservalue" name="test" type="" style="color: black;" class="test-field" />',
            $element->outputElement(),
            'Incorrect element'
        );
        $this->assertEquals(
            '<div class="formgroup"><label for="test-field">Title:</label> <input id="test-field" value="uservalue" name="test" type="" style="color: black;" class="test-field" />  </div><br />',
